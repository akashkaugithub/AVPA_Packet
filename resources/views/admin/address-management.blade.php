                ...
                <div class="delete-pop-wrap">
                    <form id="edit-form">
                        ...
                        <div class="edit-pop-form mt-3">
                            ...
                            <div class="edit-pop-in">
                                <label>Email</label>
                                <input type="text" placeholder="Enter Email" class="edit-field" name="email">
                            </div>
                            <div class="edit-pop-in">
                                <label>Phone</label>
                                <input type="text" placeholder="Enter Phone" class="edit-field" name="phone">
                            </div>
                            <div class="edit-pop-in">
                                <label>Address</label>
                                <input type="text" placeholder="Enter Address" class="edit-field" name="address">
                            </div>
                            <div class="delete-pop-btn mt-4">
                                <button type="submit" class="btn-save">Save</button>
                            </div>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.edit-btn', function() {
        var id = $(this).data('id');
        $.get('/user-address/' + id, function(data) {
            var modal = $('#edit-pop');
    ...
    $('#edit-form').on('submit', function(e) {
        ...
        $.post('/update-address/' + id, formData, function(res) {
            toastr.success(res.success);
            $('#edit-pop').modal('hide');
            setTimeout(() => location.reload(), 800);
    ...
    $(document).on('click', '.status-btn', function() {
        ...
        $.post('/change-status-address/' + id + '/' + status, {
            _token: '{{ csrf_token() }}'
        }, function(res) {
            toastr.success(res.success);
            setTimeout(() => location.reload(), 800);
