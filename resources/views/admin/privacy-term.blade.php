...
@section('title', 'Privacy & Term Condition')
@section('content')
<main>
    <div class="tabandpill-wrap">
        <div class="container-fluid">
            <ul class="nav nav-pills nav-justified">
                <li class="nav-item">
                    <a class="nav-link active" href="#Whoneed" data-toggle="tab">Privacy Policy</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#YourBenefits" data-toggle="tab">Terms & Condition</a>
                </li>
        ...
        <div class="tab-content" id="ex2-content">
            ...
            <div class="tab-pane fade show active" id="Whoneed" role="tabpanel" aria-labelledby="ex3-tab-1">
                <textarea class="editable-editor" rows="15" name="privacy_policy" id="privacy_policy" readonly>{{$privacyTerms->privacy_policy}}</textarea>
            </div>

            <!-- Terms and Conditions Section -->
            <div class="tab-pane fade" id="YourBenefits" role="tabpanel" aria-labelledby="ex3-tab-2">
                <textarea class="editable-editor" rows="15" name="terms_condition" id="terms_condition" readonly>{{$privacyTerms->terms_condition}}</textarea>
            </div>
