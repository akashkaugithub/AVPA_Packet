...
<!-- Page Header Start -->
<div class="container-fluid page-header-taxation mb-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container">
        <h1 class="display-3 mb-4 animated slideInDown">Taxation</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <!-- <li class="breadcrumb-item"><a href="#">Pages</a></li> -->
                <li class="breadcrumb-item active" aria-current="page">Taxation</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="container-xxl py-5">
    <div class="container">
        ...
        <div class="content text-start">
            <p>
                Our taxation services are designed to simplify the complexities of direct and indirect taxes. From income tax planning, GST compliance, and filing returns to handling assessments and representation before tax authorities, we ensure that your tax affairs are managed with accuracy and foresight. We help you not only stay compliant but also optimize tax efficiency to achieve maximum benefits within the legal framework.
            </p>
